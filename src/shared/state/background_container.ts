...
export const getExecutableBackgroundContainerActions = (
	dispatch: Dispatch<BackgroundContainerAction>
...
// tslint:disable-next-line:max-line-length
export const BackgroundContainerReducer = (
	state: BackgroundContainerState | undefined,
	action: BackgroundContainerAction
